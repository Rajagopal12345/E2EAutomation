...
public class JTricksRESTClient {
	...
	public static void main(String[] args) {
		...
		String auth = new String(Base64.encode("rajagopaltester@yahoo.com:Kavitha1988@"));
		...
		try {
			...
			//Create Issue
			String createIssueData = "{\"fields\":{\"project\":{\"key\":\"AUT\"},\"summary\":\"REST Test\",\"issuetype\":{\"name\":\"Bug\"}}}";
			...
			//Update Issue
			String editIssueData = "{\"fields\":{\"summary\":\"Rajagopa Automation\"}}}";
			invokePutMethod(auth, BASE_URL+"/rest/api/2/issue/"+newKey, editIssueData);
			
			invokeDeleteMethod(auth, BASE_URL+"/rest/api/2/issue/AUT-1");
